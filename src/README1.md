...
5. Perubahan mode expired. 
	...
	Mode baru ini tidak lagi menggunakan scheduler per user. Sebagai gantinya informasi tanggal expired akan dipindahkan ke comment user setelah login.# MikhMon Agent System

🚀 **Sistem Penjualan Voucher WiFi Otomatis untuk MikroTik Hotspot**

Sistem lengkap untuk mengelola penjualan voucher WiFi dengan multiple agent, payment gateway, dan direct profile links untuk hotspot login page.
